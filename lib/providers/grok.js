...
import { httpLlmError, idleWatchdog, mapFetchFailure, mergeReasoning, AccountCatalogCache, discoverAcrossAccounts, discoverOrRetryAuth, isDiscoveryAborted, isMissingOrInvalidCredential, oauthEndpointError, OAuthEndpointError, } from './common.js';
import { AccountTokenManager, DISCOVERY_TIMEOUT_MS, unionAccountCatalogs } from './accounts.js';
import { proxiedFetch } from '../http.js';
import { DEFAULT_RATE_LIMIT_WAIT, DEFAULT_RETRY, jsonBody, resetFromFields, resetInstantFromDate, subscriptionRetryPolicy, } from './rate-limit.js';
 ...
 */
export function grokRequestBody(options, resolved) {
    return {
        model: options.model,
