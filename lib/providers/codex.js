...
import { deterministicSessionId, effortDisplayName, streamWithAuthRetry, mergeReasoning, AccountCatalogCache, discoverAcrossAccounts, discoverOrRetryAuth, isDiscoveryAborted, isMissingOrInvalidCredential, oauthEndpointError, OAuthEndpointError, } from './common.js';
...
export class CodexAdapter extends LlmAdapter {
     ...
     */
    async fastCapableModels(account) {
        if (!this.options.discovery)
            return [];
